...
<div class="mr-auto mb-3">
    <h2 class="font-w700 text-primary" style="color: var(--ot-navy) !important; font-weight: 700; font-size: 22px;">Data Terapis & Tenaga Medis</h2>
    <p class="text-muted mb-0">Kelola master data terapis, spesialisasi, dan penempatan lokasi di Omah Terapiku</p>
</div>
        ...
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
            <div class="modal-header" style="border-bottom: 1px solid #edf2f7; background: #f8fafc; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                <h5 class="modal-title font-w700" style="color: var(--ot-navy) !important; font-size: 16px;">
                    <i class="fa fa-user-md text-primary mr-2"></i> Tambah Data Terapis Baru
                </h5>
            ...
            <div class="modal-body p-4">
                <form action="{{Route('dokter.store')}}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        <label class="font-w600 text-black mb-1" style="font-size: 13px;">Nama Lengkap Terapis <span class="text-danger">*</span></label>
                        <input type="text" name="nama" required class="form-control" value="{{ old('nama') }}" placeholder="Contoh: dr. Ahmad Fauzi, Sp.KFR / Sdr. Budi Santoso, S.Tr.Kes" style="height: 40px; font-size: 13px;">
                        @error('nama')
                    ...
                    <div class="form-group mb-3">
                        <label class="font-w600 text-black mb-1" style="font-size: 13px;">NIP / Nomor Registrasi</label>
                        <input type="text" name="nip" class="form-control" value="{{ old('nip') }}" placeholder="Contoh: 198902152014021001" style="height: 40px; font-size: 13px;">
                        @error('nip')
                            <div class="invalid-feedback animated fadeInUp" style="display: block;">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <label class="font-w600 text-black mb-1" style="font-size: 13px;">Penempatan Omah Terapiku <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group mb-3">
                        <label class="font-w600 text-black mb-1" style="font-size: 13px;">No. HP / WhatsApp (Login) <span class="text-danger">*</span></label>
                        <input type="text" name="no_hp" required class="form-control" value="{{ old('no_hp') }}" placeholder="Contoh: 081234567890" style="height: 40px; font-size: 13px;">
                        <small class="text-muted">Nomor ini digunakan juga sebagai identitas login terapis.</small>
                        @error('no_hp')
                            <div class="invalid-feedback animated fadeInUp" style="display: block;">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-4">
                        <label class="font-w600 text-black mb-1" style="font-size: 13px;">Alamat Domisili / Keterangan</label>
                        <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat tinggal atau keterangan spesialisasi..." style="font-size: 13px;">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback animated fadeInUp" style="display: block;">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end" style="gap: 8px;">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 20px; font-size: 13px; font-weight: 600; border-radius: 6px;">
                            <i class="fa fa-save mr-1"></i> Simpan Terapis
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card" style="border-radius: 12px; border: none; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.06);">
            <div class="card-body">
                ...
                <div class="row mb-3 align-items-center">
                    <!-- Tombol Tambah Kiri -->
                    <div class="col-md-4 col-12 mb-2 mb-md-0 d-flex align-items-center flex-wrap" style="gap: 6px;">
                        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addOrderModal" style="font-size: 13px; padding: 7px 14px; font-weight: 600;">
                            <i class="fa fa-plus mr-1"></i> Tambah Terapis
                        </a>
                    </div>

                    <!-- Filter Omah Terapiku, Status, & Pencarian Kanan -->
                    <div class="col-md-8 col-12">
                        <form method="get" action="{{ url()->current() }}">
                            <div class="d-flex align-items-center justify-content-md-end flex-wrap" style="gap: 6px;">
                                <!-- Dropdown Filter Lokasi Omah Terapiku -->
                                <select name="poli" class="form-control form-control-sm" onchange="this.form.submit()" style="max-width: 165px; height: 36px; font-size: 12.5px;">
                                ...
                                <select name="status" class="form-control form-control-sm" onchange="this.form.submit()" style="max-width: 140px; height: 36px; font-size: 12.5px;">
                                ...
                                <div class="input-group" style="max-width: 220px;">
                                    <input type="text" class="form-control form-control-sm gp-search" name="keyword" value="{{request('keyword')}}" placeholder="Cari nama, NIP, HP..." autocomplete="off" style="height: 36px; font-size: 12.5px;">
                                ...
                                @if(request('keyword') || request('poli') || request('status') !== null && request('status') !== '')
                                    <a href="{{ Route('terapis') }}" class="btn btn-sm btn-light" style="height: 36px; display: inline-flex; align-items: center; justify-content: center; padding: 0 10px; border: 1px solid #e2e8f0;" title="Reset Filter">
                    ...
                    <table class="table table-responsive-md" style="font-size: 13px;">
                        <thead>
                            <tr style="font-size: 12.5px;">
                                <th style="width: 5%;">#</th>
                                <th style="width: 26%;">Nama Terapis</th>
                                <th style="width: 16%;">NIP / Identitas</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">
                                            <strong style="font-size: 13.5px; color: #1e293b;">
                                                <i class="fa fa-user-md text-primary mr-1"></i> {{$row->nama}}
                                            </strong>
                                            @if($row->alamat)
                                                <br><small class="text-muted" style="font-size: 11.5px;"><i class="fa fa-map-marker mr-1"></i>{{$row->alamat}}</small>
                                            @endif
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <span class="badge badge-light text-dark font-w600" style="font-size: 11.5px; border: 1px solid #e2e8f0; background: #fff;">
                                                {{$row->user->nip ?? ($row->nip ?: '-')}}
                                            </span>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <span style="color: #475569; font-size: 12.5px;">
                                                <i class="fa fa-phone text-muted mr-1"></i>{{$row->no_hp ?: '-'}}
                                            </span>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <span class="badge badge-light text-dark font-w600" style="font-size: 11.5px; border: 1px solid #e2e8f0; background: #fff;">
                                        ...
                                        <td style="white-space: nowrap; vertical-align: middle;">
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#edit{{$row->id}}" 
                                                    class="btn btn-info shadow btn-xs sharp mr-1" title="Edit Terapis">
                                                    <i class="fa fa-pencil"></i>
                                                </a>

                                                <a href="#" class="btn btn-danger shadow btn-xs sharp delete" r-link="{{Route('dokter.delete',$row->id)}}"
                                                   r-name="{{$row->nama}}" r-id="{{$row->id}}" title="Hapus / Nonaktifkan Terapis">
                                                    ...
                                                    <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                                                        <div class="modal-header" style="border-bottom: 1px solid #edf2f7; background: #fff8e7; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                                                            <h5 class="modal-title font-w700" style="color: #b7791f !important; font-size: 16px;">
                                                                <i class="fa fa-key text-warning mr-2"></i> Ganti Password - {{$row->nama}}
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 22px;">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                            ...
                                            <div class="modal fade" id="edit{{$row->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                                                        <div class="modal-header" style="border-bottom: 1px solid #edf2f7; background: #f8fafc; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                                                            <h5 class="modal-title font-w700" style="color: var(--ot-navy) !important; font-size: 16px;">
                                                                <i class="fa fa-pencil-square-o text-primary mr-2"></i> Edit Data Terapis
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 22px;">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        ...
                                                        <div class="modal-body p-4 text-left">
                                                            <form action="{{Route('dokter.update',$row->id)}}" method="POST">
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    <label class="font-w600 text-black mb-1" style="font-size: 13px;">NIP / Nomor Registrasi</label>
                                                                    <input type="text" name="nip" value="{{$row->user->nip ?? ''}}" class="form-control" style="height: 40px; font-size: 13px;">
                                                                </div>
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    <label class="font-w600 text-black mb-1" style="font-size: 13px;">No. HP / WhatsApp (Login) <span class="text-danger">*</span></label>
                                                                    <input type="text" name="no_hp" required class="form-control" value="{{$row->no_hp}}" style="height: 40px; font-size: 13px;">
                                                                </div>
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <small class="text-muted">Isi hanya jika ingin memperbarui kata sandi akun terapis ini.</small>
                                                                </div>
                            ...
                            @else
                                <tr>
                                    <td colspan="7" class="text-center py-4 text-muted">
                                        <p class="mb-0 fs-13">Tidak ada data terapis yang sesuai.</p>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
...
<script>
    $(document).ready(function () {
        $(".delete").click(function(e) {
            ...
            Swal.fire({
                title: 'Ingin Menghapus / Nonaktifkan?',
                text: "Yakin ingin memproses data terapis: " + name + " ini?",
                type: 'warning',
