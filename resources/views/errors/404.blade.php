...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Omah Terapiku</title>
...
<body>
    <div class="error-card">
        ...
        <p class="error-description">
            Maaf, halaman atau data yang Anda cari tidak tersedia, telah dipindahkan, atau alamat URL yang Anda tuju salah.
        </p>
