        ...
        <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
            @if($assessment)
                <div class="btn-group btn-group-sm" role="group" aria-label="Mode Cetak">
                    <button type="button" id="btnModeFilled" class="btn btn-primary" onclick="setDocumentMode('filled')" style="font-size: 11px; padding: 5px 9px; font-weight: bold; border-radius: 4px 0 0 4px;" title="Tampilkan SOAP & Modul Asesmen yang Terisi Saja">
                        <i class="fa-solid fa-filter mr-1"></i> Modul Terisi
                    </button>
                    <button type="button" id="btnModeAll" class="btn btn-outline-secondary" onclick="setDocumentMode('all')" style="font-size: 11px; padding: 5px 9px; font-weight: bold; border-radius: 0;" title="Tampilkan SOAP & Seluruh 15 Modul Asesmen Lengkap">
                        <i class="fa-solid fa-layer-group mr-1"></i> 15 Modul Lengkap
                    </button>
                    <button type="button" id="btnModeSoapOnly" class="btn btn-outline-secondary" onclick="setDocumentMode('soap_only')" style="font-size: 11px; padding: 5px 9px; font-weight: bold; border-radius: 0 4px 4px 0;" title="Tampilkan Lembar SOAP Saja">
...
<div class="print-container" id="print-area">
    ...
    <!-- =========================================================================
         BAGIAN II: PENGKAJIAN & ASESMEN KLINIS TERPADU (HASIL EVALUASI LENGKAP)
         ========================================================================= -->
    @if($assessment)
    <div id="assessment-container">
        ...
        <!-- 1. KEMAMPUAN MOTORIK KASAR & HALUS -->
        <div class="assessment-section-block" id="sec-block-1" data-section-id="1" data-has-data="{{ $has_m1 ? '1' : '0' }}" data-title="KEMAMPUAN MOTORIK KASAR & HALUS" style="{{ $has_m1 ? '' : 'display: none;' }}">
            ...
            <table class="table-assessment">
                ...
                <tbody>
                    <tr><td class="text-center">1</td><td>Mengangkat Kepala</td><td><span class="badge-val">{{ $assessment->motorik_mengangkat_kepala ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">2</td><td>Posisi Tengkurap</td><td><span class="badge-val">{{ $assessment->motorik_posisi_tengkurap ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">3</td><td>Posisi Duduk</td><td><span class="badge-val">{{ $assessment->motorik_posisi_duduk ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">4</td><td>Merangkak</td><td><span class="badge-val">{{ $assessment->motorik_merangkak ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">5</td><td>Berlutut</td><td><span class="badge-val">{{ $assessment->motorik_berlutut ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">6</td><td>Berjalan</td><td><span class="badge-val">{{ $assessment->motorik_berjalan ?: '-' }}</span></td></tr>
                </tbody>
            </table>
        ...
        <div class="assessment-section-block" id="sec-block-2" data-section-id="2" data-has-data="{{ $has_m2 ? '1' : '0' }}" data-title="GROSS MOTOR FUNCTION MEASURE (GMFM-88)" style="{{ $has_m2 ? '' : 'display: none;' }}">
            ...
            @if(!is_null($assessment->gmfm_dimensi_a_total) || !is_null($assessment->gmfm_dimensi_b_total) || !is_null($assessment->gmfm_dimensi_c_total) || !is_null($assessment->gmfm_dimensi_d_total) || !is_null($assessment->gmfm_dimensi_e_total))
                ...
                <table class="table-assessment" style="font-size: 8pt; margin-bottom: 4px;">
                    <thead>
                        <tr>
                            <th style="width: 6%; text-align: center;">No</th>
                ...
                @endif
            @else
                <div style="font-size: 8.5pt; color: #555; margin-bottom: 6px; font-style: italic;">
                    Item GMFM-88 belum diuji / diisi.
                </div>
            @endif
        </div>
        ...
        <div class="assessment-section-block" id="sec-block-3" data-section-id="3" data-has-data="{{ $has_m3 ? '1' : '0' }}" data-title="KEMAMPUAN AKTIVITAS SEHARI-HARI (ADL)" style="{{ $has_m3 ? '' : 'display: none;' }}">
            ...
            <table class="table-assessment">
                ...
                <tbody>
                    <tr><td class="text-center">1</td><td>Kontak Mata</td><td><span class="badge-val">{{ $assessment->adl_kontak_mata ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">2</td><td>Bisa Duduk Tenang Saat Melakukan Aktivitas</td><td><span class="badge-val">{{ $assessment->adl_duduk_tenang ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">3</td><td>Gerakan Berulang dan Tidak Bertujuan</td><td><span class="badge-val">{{ $assessment->adl_gerakan_berulang ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">4</td><td>Merespon Saat Dipanggil Nama</td><td><span class="badge-val">{{ $assessment->adl_respon_nama ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">5</td><td>Makan</td><td><span class="badge-val">{{ $assessment->adl_makan ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">6</td><td>Mandi</td><td><span class="badge-val">{{ $assessment->adl_mandi ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">7</td><td>Berpakaian</td><td><span class="badge-val">{{ $assessment->adl_berpakaian ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">8</td><td>BAK (Buang Air Kecil)</td><td><span class="badge-val">{{ $assessment->adl_bak ?: '-' }}</span></td></tr>
                    <tr><td class="text-center">9</td><td>BAB (Buang Air Besar)</td><td><span class="badge-val">{{ $assessment->adl_bab ?: '-' }}</span></td></tr>
                </tbody>
            </table>
        ...
        <div class="assessment-section-block" id="sec-block-13" data-section-id="13" data-has-data="{{ $has_m13 ? '1' : '0' }}" data-title="PERENCANAAN TERAPI & PROGRAM INTERVENSI" style="{{ $has_m13 ? '' : 'display: none;' }}">
            ...
            <table class="table-assessment text-center" style="font-size: 8.5pt; margin-bottom: 6px;">
                <thead>
                    <tr>
        ...
        <div class="assessment-section-block" id="sec-block-14" data-section-id="14" data-has-data="{{ $has_m14 ? '1' : '0' }}" data-title="KESIMPULAN & EVALUASI KLINIS" style="{{ $has_m14 ? '' : 'display: none;' }}">
            ...
            <div class="no-break" style="border: 1px solid #000000; padding: 6px 10px; margin-bottom: 8px; font-size: 8.5pt;">
                <div style="margin-bottom: 4px;">
                    <strong>Kesimpulan &amp; Evaluasi Klinis:</strong>
                    <p style="margin: 2px 0 0 0; color: #000; white-space: pre-line;">{{ $assessment->kesimpulan ?: '-' }}</p>
                </div>
                @if($assessment->rencana_terapi)
                    <div style="border-top: 1px dashed #000; padding-top: 4px; margin-top: 4px;">
                        ...
                        <p style="margin: 2px 0 0 0; color: #000; white-space: pre-line;">{{ $assessment->rencana_terapi }}</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="assessment-section-block" id="sec-block-15" data-section-id="15" data-has-data="{{ $has_m15 ? '1' : '0' }}" data-title="SKALA PERKEMBANGAN DENVER II (DDST II)" style="{{ $has_m15 ? '' : 'display: none;' }}">
            ...
            @if($has_m15)
                ...
                <table class="table-assessment" style="font-size: 8pt; margin-bottom: 6px;">
                    <thead>
                        <tr>
                            <th style="width: 6%; text-align: center;">No</th>
                    ...
                    <tbody>
                        @foreach($denver_print_sectors as $sec)
                            <tr style="background: #f0f0f0;">
                                <td colspan="5" style="font-weight: bold; font-size: 8.5pt;">
                                    {{ $sec['title'] }}
                                </td>
                            </tr>
...
<script>
var currentMode = 'filled'; // 'filled' (SOAP + modul terisi), 'all' (SOAP + 15 modul), atau 'soap_only' (SOAP saja)
...
function setDocumentMode(mode) {
    ...
    if (btnFilled) btnFilled.className = (mode === 'filled') ? 'btn btn-primary' : 'btn btn-outline-secondary';
    if (btnAll) btnAll.className = (mode === 'all') ? 'btn btn-primary' : 'btn btn-outline-secondary';
    if (btnSoapOnly) btnSoapOnly.className = (mode === 'soap_only') ? 'btn btn-primary' : 'btn btn-outline-secondary';
...
function downloadPDF() {
    ...
    var opt = {
        ...
        pagebreak:    { 
            ...
            avoid: ['tr', 'tbody tr', '.section-title', '.table-assessment', '.soap-block', '.box-rekap', '.box-subdimensi', '.sign-area', '.no-break', '.print-block', '.header-box-table']
        }
    };
