                    ...
                    <form action="{{Route('rekam.update', $data->id)}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" name="tgl_rekam" class="form-control" value="{{old('tgl_rekam', $data->tgl_rekam)}}" style="height: 42px; font-size: 13px; border-radius: 8px;" required>
                                @error('tgl_rekam')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" id="pasien_nama" class="form-control font-w600"
                                      ...
                                      name="pasien_nama" readonly style="background-color: #fff; cursor: pointer; height: 42px; font-size: 13px; border-radius: 8px 0 0 8px;" placeholder="Klik untuk memilih penerima manfaat...">
                        ...
                        <div class="d-flex align-items-center mb-3 mt-4 pb-2" style="border-bottom: 2px solid #edf2f7;">
                            <h5 class="font-w700 mb-0" style="color: #1e40af !important; font-size: 15px;">
                                <i class="fa-solid fa-comment-dots mr-2" style="color: #2563eb;"></i> 3. Anamnesa & Keluhan
                            </h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="keluhan" required class="form-control" rows="4" placeholder="Tuliskan keluhan utama, kondisi fisik, atau hasil anamnesa..." style="font-size: 13px; border-radius: 8px;">{{old('keluhan', $data->keluhan)}}</textarea>
                                @error('keluhan')
                                    <div class="invalid-feedback animated fadeInUp" style="display: block;">{{$message}}</div>
                                @enderror
                            </div>
