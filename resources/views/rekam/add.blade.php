            ...
            <div class="card-body p-4">
                <div class="basic-form">
                    <form action="{{Route('rekam.store')}}" method="POST">
                        ...
                        <div class="d-flex align-items-center mb-3 mt-4 pb-2" style="border-bottom: 2px solid #edf2f7;">
                            <h5 class="font-w700 mb-0" style="color: #1e40af !important; font-size: 15px;">
                                <i class="fa-solid fa-comment-dots mr-2" style="color: #2563eb;"></i> Anamnesa & Keluhan Awal
                            </h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="keluhan" required class="form-control" rows="4" placeholder="Tuliskan keluhan utama, kondisi fisik, atau hasil anamnesa awal penerima manfaat..." style="font-size: 13px; border-radius: 8px; border: 1.5px solid #cbd5e1; line-height: 1.6;">{{old('keluhan')}}</textarea>
                                @error('keluhan')
                                    <div class="invalid-feedback animated fadeInUp" style="display: block;">{{$message}}</div>
                                @enderror
                            </div>
