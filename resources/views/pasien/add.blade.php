                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="d-flex flex-wrap" style="gap: 8px;">
                                    ...
                                    @foreach($abOpts as $abOpt)
                                        <label class="check-pill-card ab-option-pill {{ in_array($abOpt, $oldAb) && !$isTidakAda ? 'active' : '' }}" style="padding: 7px 16px; font-size: 12.5px; border-radius: 8px; {{ $isTidakAda ? 'display: none !important;' : '' }}">
...
<script>
    ...
    // =========================================================================
    // INTEGRASI API WILAYAH.ID BERJENJANG DENGAN SELECT2 SEARCHABLE (Wilayah.id via Proxy)
    // =========================================================================
