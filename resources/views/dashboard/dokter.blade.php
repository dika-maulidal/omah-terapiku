    ...
    <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; background: #ffffff; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.05);">
        <div class="card-body p-3 p-md-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <div class="mr-auto">
                    <h3 class="font-w700 mb-0" style="color: var(--ot-navy, #1e40af) !important; font-weight: 700; font-size: 22px;">Dashboard Terapis</h3>
                    <p class="fs-13 text-muted mb-0 mt-1">Selamat Datang, <strong class="font-w700" style="color: #2563eb;">{{ auth()->user()->name }}</strong> &bull; Panel Pelayanan Medis Omah Terapiku</p>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="ot-stat-card ot-yellow">
                ...
                <div class="ot-stat-footer">
                    <span class="badge badge-pill badge-primary light">Menunggu</span>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="ot-stat-card ot-navy">
                ...
                <div class="ot-stat-footer">
                    <span class="badge badge-pill badge-info light">Selesai</span>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="ot-stat-card ot-cyan">
                ...
                <div class="ot-stat-footer">
                    <span class="badge badge-pill badge-primary light">Terdaftar</span>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="ot-stat-card ot-green">
                ...
                <div class="ot-stat-footer">
                    <span class="badge badge-pill badge-info light">Total</span>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-4 col-lg-12 mb-3 mb-xl-0">
            <div class="card h-100 mb-0 shadow-sm" style="border-radius: 12px; border: none; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.06);">
                <div class="card-header d-flex justify-content-between align-items-center py-3" style="border-bottom: 1px solid #edf2f7;">
                    <h4 class="fs-15 font-w700 text-primary mb-0" style="color: var(--ot-navy) !important; font-weight: 700;">
                        <i class="fa fa-hourglass-half mr-1" style="color: #2563eb;"></i> Pasien Menunggu
                    </h4>
                    ...
                    <div class="dz-scroll" style="overflow-y: auto; max-height: 380px; padding-right: 4px;">
                        ...
                        @else
                            <div class="text-center py-5 text-muted">
                                <i class="fa fa-check-circle-o text-primary fs-24 mb-2 d-block" style="color: #2563eb !important;"></i>
                                <p class="fs-13 mb-0">Tidak ada antrian pasien menunggu saat ini.</p>
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-lg-12">
            <div class="card h-100 mb-0 shadow-sm" style="border-radius: 12px; border: none; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.06);">
                <div class="card-header d-flex justify-content-between align-items-center py-3" style="border-bottom: 1px solid #edf2f7;">
                    <h4 class="fs-15 font-w700 text-primary mb-0" style="color: var(--ot-navy) !important; font-weight: 700;">
                        <i class="fa fa-check-circle mr-1" style="color: #2563eb;"></i> Pasien Selesai Hari Ini
                    </h4>
                    <span class="badge badge-primary light font-w600">
                ...
                <div class="card-body p-3">
                    <div class="dz-scroll" style="overflow-y: auto; max-height: 380px; padding-right: 4px;">
                        @php
                            $selesaiHariIni = $query->rekam_day()->whereIn('status', [4, 5]);
                        @endphp
                        @if ($selesaiHariIni->count() > 0)
                            @foreach ($selesaiHariIni as $item)
                                <div class="ot-schedule-item d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center" style="min-width: 0;">
                                        <div class="ot-patient-avatar" style="background-color: #2563eb; color: #fff;">
                                        ...
                                        <div style="min-width: 0;">
                                            ...
                                            <ul class="ot-meta-list">
                                                ...
                                                <li>
                                                    ...
                                                    {{ $item->layanan_terapi ?: $item->poli }}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center flex-shrink-0 ml-2">
                                        <a href="{{ Route('rekam.detail', $item->pasien_id) }}" class="btn btn-xs btn-outline-primary shadow-sm" title="Lihat Rekam Medis">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        @else
                            <div class="text-center py-5 text-muted">
                                ...
                                <p class="fs-13 mb-0">Belum ada pasien yang selesai diperiksa hari ini.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="card shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; background: #ffffff; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.05); overflow: hidden;">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center py-3" style="border-bottom: 1px solid #edf2f7; background: #ffffff;">
                    <div class="d-flex align-items-center mb-2 mb-sm-0">
                        ...
                        <div>
                            <h4 class="fs-16 font-w700 mb-0" style="color: var(--ot-navy) !important; font-weight: 700;">
                                Log Aktivitas Pelayanan Anda & Tim
                            </h4>
                            <p class="fs-12 text-muted mb-0">Catatan pengisian asesmen, pemeriksaan fisik, proses terapi, dan sesi selesai</p>
                        </div>
                    </div>
