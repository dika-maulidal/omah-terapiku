...
@section('content')
    <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div class="mr-auto">
            ...
            <p class="mb-0">Omah Terapiku Terapis {{auth()->user()->name}} Dashboard</p>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>Penerima Manfaat Sedang Antri</span>
                        </div>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>Total Penerima Manfaat Anda</span>
                        </div>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-xl-12">
            <div class="row">
                <div class="col-xl-12">	
                    <div class="card appointment-schedule">
                        <div class="card-header pb-0 border-0">
                            <h3 class="fs-20 text-black mb-0">Penerima Manfaat Perlu Anda Periksa</h3>
                                                ...
                                                <div class="d-flex pb-3 border-bottom mb-3 align-items-end">
                                                    <div class="mr-auto">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><i class="las la-user"></i>Terapis : {{$item->dokter->nama}}</li>
                                                        </ul>
                                                    </div>
                ...
                <div class="col-xl-12">	
                    <div class="card appointment-schedule">
                        <div class="card-header pb-0 border-0">
                            <h3 class="fs-20 text-black mb-0">Penerima Manfaat Anda Hari Ini</h3>
