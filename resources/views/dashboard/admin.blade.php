...
@section('content')
    ...
    <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; background: #ffffff; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.05);">
        <div class="card-body p-3 p-md-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <div class="mr-auto">
                    <h3 class="font-w700 mb-0" style="color: var(--ot-navy, #1e40af) !important; font-weight: 700; font-size: 22px;">Dashboard Utama</h3>
                    <p class="fs-13 text-muted mb-0 mt-1">Selamat Datang, <strong class="font-w700" style="color: #2563eb;">{{ auth()->user()->name }}</strong> &bull; Sistem Informasi Rekam Medis Omah Terapiku</p>
                </div>
                <div class="mt-2 mt-sm-0 d-flex align-items-center" style="gap: 8px;">
                    <a href="{{ route('laporan.eksekutif') }}" class="btn btn-sm btn-primary font-w700 shadow-sm" style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%) !important; border: none; padding: 8px 16px; font-size: 12.5px; border-radius: 8px; box-shadow: 0 4px 12px rgba(37,99,235,0.25);">
                        <i class="fa-solid fa-file-invoice mr-1.5"></i> Laporan Eksekutif (PDF)
                    </a>
    ...
    <div class="row">
        <!-- Card 1: Periksa Hari Ini (Ocean Navy #2D4B7A) -->
    ...
    <!-- Main Content Row (2 Columns: Status Antrian & Perawatan Hari Ini) -->
    <div class="row mb-4">
        ...
        <div class="col-xl-6 col-lg-12 mb-3 mb-xl-0">
            <div class="card h-100 mb-0 shadow-sm" style="border-radius: 12px; border: none; box-shadow: 0 4px 18px rgba(46, 75, 130, 0.06);">
                ...
                <div class="card-body p-3">
                    <div class="dz-scroll" id="appointment-schedule" style="overflow-y: auto; max-height: 275px; padding-right: 4px;">
