...
// Fallback safety timeout (guarantees preloader never hangs)
setTimeout(function() {
...
(function($) {
    ...
    $(document).on('click', function(e) {
        if ($(window).innerWidth() < 768 && $('#main-wrapper').hasClass('menu-toggle')) {
            if (!$(e.target).closest('.deznav, .nav-control').length) {
